...
// export function check(_values: CustomVictoryLineChartPreviewProps): Problem[] {
...
// export function getPreview(values: CustomVictoryLineChartPreviewProps, isDarkMode: boolean, version: number[]): PreviewProps {
...
// export function getCustomCaption(values: CustomVictoryLineChartPreviewProps, platform: Platform): string {
//     return "CustomVictoryLineChart";
// }
